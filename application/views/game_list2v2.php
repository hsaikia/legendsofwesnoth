...
foreach ($games as $game) {
	echo "<tr><td class='timestamp'>[". $game->date ."]</td><td style='font-size:14px;'>" . getColoredHandle($game->handle_w1, $game->rating_w1) . " (" . $faction[$game->faction_w1] . ") and " . getColoredHandle($game->handle_w2, $game->rating_w2) . " (" . $faction[$game->faction_w2] . ") ";
	echo " defeated ";
