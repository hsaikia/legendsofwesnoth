...
<?php echo validation_errors(); ?>
	...
	<table>
	<tr>
	<td class="label"><strong>Handle</strong> </td>
	<td class="field"><?php echo $profile->handle; ?></td>
	</tr>
    ...
    <option value="WO" selected>(please select a country)</option>
    <option value="WO">Citizen of the World</option>
	...
	<hr>
	<table>
	<tr><td class="label"><input id="gobutton" type="submit" value="Edit Profile" size="3" /></td>
