...
(function($){
	$.fn.extend({ 
		...
		var options = $.extend(defaults, options);
			...
			{
				$(obj).append('<div id="textholder'+randID+'_'+i+'" class="textholder" style="position:absolute; padding-left:10px;width:'+imgWidth+'px;bottom:0px;margin-bottom:'+-(imgHeight*o.textholderHeight+containerBorder)+'px;"><span></span></div>');
				...
				$('#textholder'+randID+'_'+i).height(imgHeight*o.textholderHeight).css({'backgroundColor':'#000','opacity':'0.8'});
			...
			if(o.showControls)
			{
				...
				html = '<div id="btn_rt'+randID+'" style="position:absolute;right:2px;top:'+arrowsTop+'px;cursor:pointer;border:none;width:66px;height:66px;background:url('+o.imagePath+'brbl.png) no-repeat 0 0"></div>';
				html += '<div id="btn_lt'+randID+'" style="position:absolute;left:2px;top:'+arrowsTop+'px;cursor:pointer;border:none;width:66px;height:66px;background:url('+o.imagePath+'brbl.png) no-repeat -66px 0"></div>';
